...
urlpatterns = [
    ...
    path('api/show/class/by/teacher/<int:pk>/', views.show_class_by_teacher, name='show_class_by_teacher'),
    path('api/show/class/by/student/<int:pk>/', views.show_class_by_student, name='show_class_by_student'),
    path('api/show/class/by/department/<int:pk>/', views.show_class_by_department, name='show_class_by_department'),
