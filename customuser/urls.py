...
urlpatterns = [
    ...
    path(
        "api/users/update_profile/<int:u_id>/",
        views.update_profile,
        name="update_profile",
    ),
    path(
        "api/users/delete_profile/<int:u_id>/", views.delete_user, name="delete_profile"
    ),
    path(
        "api/users/show_profile/<int:u_id>/", views.get_user_by_id, name="show_profile"
    ),
]
