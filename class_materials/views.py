...
def upload_materials(request, f_id):
    ...
    try:
        ...
        return Response(
            {"message": "Materials not uploaded"}, status=status.HTTP_400_BAD_REQUEST
        )
...
def create_folder(request, c_id, t_id):
    ...
    try:
        ...
        return Response(
            {"message": "Folder created successfully"}, status=status.HTTP_201_CREATED
        )
    except:
        return Response(
            {"message": "Folder not created"}, status=status.HTTP_400_BAD_REQUEST
        )
...
def update_folder(request, pk):
    ...
    try:
        ...
        return Response(
            {"message": "Folder updated successfully"}, status=status.HTTP_201_CREATED
        )
    except:
        return Response(
            {"message": "Folder not updated"}, status=status.HTTP_400_BAD_REQUEST
        )
...
def delete_folder(request, pk):
    try:
        ...
        return Response(
            {"message": "Folder deleted successfully"}, status=status.HTTP_201_CREATED
        )
    except:
        return Response(
